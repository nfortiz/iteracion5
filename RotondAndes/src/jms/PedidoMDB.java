...
public class PedidoMDB implements MessageListener, ExceptionListener 
{
	...
	private final static String LOCAL_TOPIC_NAME = "java:global/RMQPedidoLocal";
	...
	private List<Pedido> answer = new ArrayList<>();
		...
		try 
		{
			...
			if(!ex.getSender().equals(APP))
			{
				if(ex.getStatus().equals(REQUEST))
				{
					...
					Topic t = new RMQDestination("", "pedido.test", ex.getRoutingKey(), "", false);
