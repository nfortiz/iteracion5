...
public class ProductoMDB implements MessageListener, ExceptionListener 
{
	...
	public ProductoMDB(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
